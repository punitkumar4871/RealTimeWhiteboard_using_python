...
def save_ss():
    a=random.randint(10,100000000)
    b=str(a)
    # Get the directory of the client file
    directory = os.path.dirname(__file__)
    # Define the path for the screenshot
    screenshot_path = os.path.join(directory, directory, b+'.png')
    # Take a screenshot
...
def main():
    ...
    # Set up the canvas (whiteboard)
    canvas = tk.Canvas(root, bg="white", width=630, height=600)
